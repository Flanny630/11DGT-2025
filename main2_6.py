...
# Version 1_2
# June 2025
# TODO: Adding projectiles - plants (done)
...
def main():
    ...
    plant_add_increment = 2000 # The first plant will be added in 2000 milliseconds when we start the game
    plant_count = 0
    ...
    while run: 
        ...
        if plant_count > plant_add_increment: 
            ...
            plant_add_increment = max(200, star_add_increment - 50) # Minimum plant add increment ever have is 200
