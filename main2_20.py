...
def main():
    ...
    # Loading player_image and adding the rect around the player to detect collisions
    ...
    while run: 
        ...
        if plant_count > plant_add_increment: 
            for _ in range(3):
                ...
                plant = pygame.Rect(plant_x + offset_x, HEIGHT // 2 + offset_y, smaller_plant_width, smaller_plant_height)
                plants.append(plant) 
        ...
        if bush_count > bush_add_increment:
            ...
            bush = pygame.Rect(bush_x + offset_x, HEIGHT // 2 + offset_y, smaller_bush_width, smaller_bush_height)
            bushes.append(bush)
